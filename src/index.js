...
// TODO: Make is dynamic, so it works with resizes
          ...
          return (
            <View style={viewer.failedImg} key={index}>
              {this.props.failedUrl ? (
                <Image style={viewer.failedImg} source={{ uri: this.props.failedUrl }} />
              ) : (
                <Image style={viewer.failedImg} source={require('./img-error.jpg')} />
              )}
            </View>
          );
      }
